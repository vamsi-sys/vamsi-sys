...
- 🌱 Learning to scale **LLM-powered agents** with real-time automation (n8n)
- 💬 Ask me about Python, FastAPI, Computer Vision, or AI Agent workflows
- 📫 Reach me at **vamsikrishnasirimalla@gmail.com**
...
Real-time news fetching, LLM-based summarization, and a chat interface — powered by n8n automation.
<br><br>
`Python` `LLMs` `n8n` `FastAPI`
